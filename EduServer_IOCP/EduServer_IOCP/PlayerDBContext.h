...
struct UpdatePlayerLogoutPositionContext : public DatabaseJobContext, public ObjectPool < UpdatePlayerLogoutPositionContext >
{
	UpdatePlayerLogoutPositionContext( ClientSession* owner, int pid ) : DatabaseJobContext( owner )
		, mPlayerId( pid ), mPosX( 0 ), mPosY( 0 ), mPosZ( 0 )
	{
	}
